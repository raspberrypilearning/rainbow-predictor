...
![слика екрана](images/rainbow-sliders.png)
...
Уколико је потребно да одштампате овај пројекат, молимо Вас користите [Верзију за штампање](https://projects.raspberrypi.org/en/projects/rainbow-predictor/print).
